...
\date{\dateline{Feb 26, 2016}{Jul 1, 2016}\\
...
H.A. Kierstead and L.~Rabern, \emph{Improved lower bounds on the number of
  edges in list critical and online list critical graphs}, \arxiv{1406.7355} (2014).
...
\bibitem{krivelevich1997minimal}
M.~Krivelevich, \emph{On the minimal number of edges in color-critical graphs},
  Combinatorica \textbf{17} (1997), no.~3, 401--426.
