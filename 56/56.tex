...
By Shannon's bound $k + 1 \le \frac32\Delta(G)$, so $S_3 \le \frac{\Delta(G)}{2} - 2$, so 
\[-13 + \parens{\frac72 + 2}\Delta(G) + \frac{\Delta(G)+2}{2}S_4 - 2S_4\Delta(G) > 0,\]
which is
\[-13 + \frac{11}{2}\Delta(G) > \frac{3\Delta(G)-2}{2}S_4,\]
so
\[\frac58|G| - 2 < S_4 < \frac{11\Delta(G)-26}{3\Delta(G)-2},\]
which implies
\[\card{G} < \frac{136}{15} - \frac{448}{15(3\Delta(G) - 2)},\]
hence $\card{G} \le 9$.
