...
Note that if $a, b \in \IN \cup \set{\infty}$ with $a \le b$, then $\gamma_a(Q) \ge \gamma_b(Q)$.  
In particular, the following generalizes the superlocal version of Reed's conjecture for line graphs
...
King and Edwards conjectured that $\gamma_\infty(Q)$ is an upper bound on the fractional chromatic number for any graph $Q$.  With a round-up, we think this
may hold for the chromatic number of line graphs.
