...
\begin{problem}
Given a graph $G$ that represents a classroom of children and their friend relationships, how can we find the online list-chromatic number of $G$?
\end{problem}
This problem is hard (supposing other problems we think are hard are in fact hard). For further standard graph theory notation, we refer the reader to Diestel's excellent textbook \cite{diestel2010}.
