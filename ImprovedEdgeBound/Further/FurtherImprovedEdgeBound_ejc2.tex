...
For standard graph theory definitions and notation, we refer the reader to Diestel's textbook \cite{diestel2010}.
...
The theorem also holds, with a nearly identical proof, for offline list coloring.  The proof is similar to the $4$-list-critical case in \cite{Better4ListCriticalBound}, but now we incorporate reducibility lemmas from Kierstead and Rabern \cite{OreVizing}.  
