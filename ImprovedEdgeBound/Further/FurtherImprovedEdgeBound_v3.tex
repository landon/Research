...
\begin{lem}\label{bwkk1}
	Let $\func{p}{\IN}{\IR_{\ge 0}}$, $\func{f}{\IN}{\IR}$, $\func{h}{\IN}{\IR_{\ge 0}}$, $\func{z}{\IN}{\IR_{\ge 0}}$. 
...
\noindent\claim{2}{$T$ has no $K_t$ endblock where $3 \le t \le k-3$.}

\noindent\claim{3}{$T$ has no $K_2$ endblock.}

\noindent\claim{4}{Each endblock of $T$ is $K_{k-2}$ or $K_{k-1}$.}

\noindent\claim{5}{$T$ has at most one $K_{k-1}$ endblock.}

\noindent\claim{6}{If $B$ is an endblock of $T$, then $d_T(x_B) = k-1$.}

\noindent\claim{7}{$T$ does not exist.}
\end{proof}
