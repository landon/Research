...
\section{Counterexamples have some sparse neighborhoods}
...
In \cite{KernelMagic}, Kierstead and R. proved a general lemma that allows the user to get list colorings for free from large independent sets.  Specialized the the Borodin-Kostochka conjecture,
this becomes.
