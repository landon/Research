...
pair of dots is connected by a curve.  Edges can be \emph{weak} or \emph{strong}.  Our goal is to assign each vertex two colors so that 
each weak edge sees at least three colors and each strong edge sees four colors.
