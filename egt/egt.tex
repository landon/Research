...
graph with no people at all.  Given one group, we can handle all graphs with no ropes.  With two groups, we can do
...
any two people are joined by a rope. \aaside{complete}{}
