...
\section*{a game version marriage theorem}
...
To prove this result, we develop a dynamic version of marriage theorem that can be conveniently phrased as a game.
