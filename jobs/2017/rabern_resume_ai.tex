...
\Large \textbf{landon rabern}  & (805) 403-8185\\
...
To understand why there is something it is like to be me.   That has always been my primary objective, 
but i first took nearly a decade teaching myself and then researching graph coloring to prove to myself that i could
excel at something ``hard''.  Now i am teaching myself all things machine learning as a first step toward the objective.
It is only logical that i work at Google Brain.
...
\squishlist
    ...
    \squishlist
        ...
        \item LINQ, \LaTeX, SQL, ASP.NET MVC, HTML, CSS, XML, XSLT, Bridge.NET, Google protobufs
        \item WinForms, WPF, Silverlight, Xamarin
    \squishend
    
    \item \textbf{Development Tools and Platforms}
    \squishlist
		\item ANTS profiler, dotTrace
...
\squishend
\newpage
\resheading{Journal Refereeing}

  \squishlist
		\item Minds and Machines (2 papers)
  	    \item Synthese (2 papers)
        \item Journal of Philosophical Logic (1 paper)
        \item Journal of Combinatorial Theory, Series B (many papers)
        \item Combinatorica (many papers)
		\item Journal of Graph Theory (many papers)
		\item SIAM Journal on Discrete Mathematics (many papers)
		\item Discrete Math (many papers)
      \squishend
