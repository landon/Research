...
\end{tabular*}
\begin{minipage}{15cm}
working with a contract R\&D company that does data analysis and machine learning for the semiconductor industry
\end{minipage}
...
\resheading{honors \& activities}
    \begin{tabular*}{7.5in}{l@{\extracolsep{\fill}}r}
        $\circ$ \textbf{erd\H{o}s number 2} & 2011 -\phantom{1}$\infty$\phantom{2}
    \end{tabular*}
