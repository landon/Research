...
\begin{tabular*}{7.5in}{l@{\extracolsep{\fill}}r}
	\textbf{Data Scientist} & 2018 - \phantom{2018}\\
	   Facebook & Cambridge, MA\\
\end{tabular*}

\mydesc{ Working with the World.AI team to ingest and digest Open Street Map diffs (Python, Presto, Giraph).}
...
I coded in solo mode on a team of 3.}
