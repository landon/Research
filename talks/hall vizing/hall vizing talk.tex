...
\3 with this we can state a necessary condition
\end{itemize}
...
\begin{picture}(1,1)(0.0, -0.11)
\put(0.6,0.5){\includegraphics[width=0.15\unitlength]{cards/AS.pdf}}
\put(0.8,0.5){\includegraphics[width=0.17\unitlength]{cards/10S.pdf}}
\put(0.4,0.5){\includegraphics[width=0.15\unitlength]{cards/JS.pdf}}
\put(0.0,0.5){\includegraphics[width=0.15\unitlength]{cards/JS.pdf}}
\put(0.2,0.5){\includegraphics[width=0.15\unitlength]{cards/JS.pdf}}

\put(0.6,0.45){\includegraphics[width=0.17\unitlength]{cards/10S.pdf}}
\put(0.8,0.45){\includegraphics[width=0.15\unitlength]{cards/QS.pdf}}
\put(0.4,0.45){\includegraphics[width=0.15\unitlength]{cards/QS.pdf}}
...
\only<4>{
\begin{picture}(1,1)(0.0, -0.11)
\put(0.6,0.5){\includegraphics[width=0.17\unitlength]{cards/AS.pdf}}
\put(0.8,0.5){\includegraphics[width=0.17\unitlength]{cards/10S.pdf}}
\put(0.4,0.5){\includegraphics[width=0.15\unitlength]{cards/JS.pdf}}
\put(0.0,0.5){\includegraphics[width=0.15\unitlength]{cards/JS.pdf}}
\put(0.2,0.5){\includegraphics[width=0.15\unitlength]{cards/JS.pdf}}
...
\put(0.4,0.5){\includegraphics[width=0.15\unitlength]{cards/JS.pdf}}
\put(0.0,0.5){\includegraphics[width=0.15\unitlength]{cards/back.pdf}}
\put(0.2,0.5){\includegraphics[width=0.17\unitlength]{cards/JS.pdf}}

\put(0.6,0.45){\includegraphics[width=0.15\unitlength]{cards/back.pdf}}
\put(0.8,0.45){\includegraphics[width=0.15\unitlength]{cards/back.pdf}}

\put(0.4,0.45){\includegraphics[width=0.17\unitlength]{cards/QS.pdf}}
...
\put(0.0,0.45){\includegraphics[width=0.17\unitlength]{cards/KS.pdf}}
\put(0.2,0.45){\includegraphics[width=0.15\unitlength]{cards/QS.pdf}}
\end{picture}}
\end{frame}
...
\2 for each $t \ge 1$, the $t$-game is where Dealer is allowed to make up to $t$ swaps.
\end{itemize}
...
\begin{itemize}
\1 take a minimum counterexample to Vizing's theorem, say it has maximum degree $\Delta$
\2 remove a vertex of degree $\Delta$ and edge-color the rest with $\Delta + 1$ colors
\end{itemize}
...
\[\sum_{C \in S} d_S(C) \ge 2|S|\]
\4 so, we have the desired winning condition
\[\sum_{C \in S} \frac{d_S(C)}{2} \ge |S|\]
\end{itemize}
\end{frame}
...
\3 Dealer can either do nothing or swap $A$ and $B$ in at most one other stack.
\4 Player wins if he can pick a Royal Flush at the start of one of his turns, otherwise Dealer wins.
\5 Player has a simple winning strategy exactly when a Hall-like condition is satisfied
\6 the fact that Player wins quickly implies Vizing's edge-coloring theorem
\7 most other classical edge-coloring results follow easily as well
\8 there is a straightforward generalization to multigraphs
\9 there is a much more general game that unifies a large chunk of edge-coloring theory
\end{itemize}
\end{frame}
