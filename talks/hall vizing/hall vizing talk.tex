...
\put(0.61,0.6){\includegraphics[width=0.17\unitlength]{cards/AS.pdf}}
\put(0.81,0.6){\includegraphics[width=0.17\unitlength]{cards/KS.pdf}}
\put(0.41,0.6){\includegraphics[width=0.17\unitlength]{cards/QS.pdf}}
\put(0.01,0.6){\includegraphics[width=0.17\unitlength]{cards/JS.pdf}}
\put(0.21,0.6){\includegraphics[width=0.17\unitlength]{cards/10S.pdf}}
\end{picture}}
\end{frame}
...
\uncover<4->{
\begin{DealerMove}
Dealer can (i) do nothing or (ii) swap $A$ and $B$ in at most one other stack.
\end{DealerMove}}
...
\put(0.6,0.55){\includegraphics[width=0.15\unitlength]{cards/KS.pdf}}
\put(0.8,0.55){\includegraphics[width=0.15\unitlength]{cards/QS.pdf}}
\put(0.41,0.55){\includegraphics[width=0.17\unitlength]{cards/QS.pdf}}

\put(0.01,0.55){\includegraphics[width=0.17\unitlength]{cards/KS.pdf}}
\put(0.2,0.55){\includegraphics[width=0.15\unitlength]{cards/KS.pdf}}
\put(0.21,0.6){\includegraphics[width=0.17\unitlength]{cards/JS.pdf}}
\put(0.61,0.6){\includegraphics[width=0.17\unitlength]{cards/AS.pdf}}
\put(0.81,0.6){\includegraphics[width=0.17\unitlength]{cards/10S.pdf}}
\end{picture}}
\end{frame}
...
If Player has a winning strategy, then for every set of stacks $S$ we must have 
...
\4 if Player's swaps $A$ in for $B$, increasing $\ceil{\frac{d_S(A)}{2}}$, then $d_S(A)$ and $d_S(B)$ both changed from even to odd
\5 Dealer can swap $A$ for $B$ somewhere else, decreasing $\ceil{\frac{d_S(B)}{2}}$ and not increasing $\ceil{\frac{d_S(A)}{2}}$
...
Player has a winning strategy if and only if for every set of stacks $S$ we have 
\[\sum_{C \in \bigcup S} \ceil{\frac{d_S(C)}{2}} \ge |S|.\]
...
\begin{picture}(1,1)(0.0, -0.11)
\put(0.6,0.5){\includegraphics[width=0.15\unitlength]{cards/AS.pdf}}
\put(0.81,0.5){\includegraphics[width=0.17\unitlength]{cards/10S.pdf}}
\put(0.4,0.5){\includegraphics[width=0.15\unitlength]{cards/JS.pdf}}
\put(0.0,0.5){\includegraphics[width=0.15\unitlength]{cards/JS.pdf}}
\put(0.2,0.5){\includegraphics[width=0.15\unitlength]{cards/JS.pdf}}

\put(0.61,0.45){\includegraphics[width=0.17\unitlength]{cards/10S.pdf}}
\put(0.8,0.45){\includegraphics[width=0.15\unitlength]{cards/QS.pdf}}
\put(0.4,0.45){\includegraphics[width=0.15\unitlength]{cards/QS.pdf}}
...
\only<4>{
\begin{picture}(1,1)(0.0, -0.11)
\put(0.61,0.5){\includegraphics[width=0.17\unitlength]{cards/AS.pdf}}
\put(0.81,0.5){\includegraphics[width=0.17\unitlength]{cards/10S.pdf}}
\put(0.4,0.5){\includegraphics[width=0.15\unitlength]{cards/JS.pdf}}
\put(0.0,0.5){\includegraphics[width=0.15\unitlength]{cards/JS.pdf}}
\put(0.2,0.5){\includegraphics[width=0.15\unitlength]{cards/JS.pdf}}
...
\put(0.4,0.5){\includegraphics[width=0.15\unitlength]{cards/JS.pdf}}
\put(0.0,0.5){\includegraphics[width=0.15\unitlength]{cards/back.pdf}}
\put(0.21,0.5){\includegraphics[width=0.17\unitlength]{cards/JS.pdf}}

\put(0.6,0.45){\includegraphics[width=0.15\unitlength]{cards/back.pdf}}
\put(0.8,0.45){\includegraphics[width=0.15\unitlength]{cards/back.pdf}}

\put(0.41,0.45){\includegraphics[width=0.17\unitlength]{cards/QS.pdf}}
...
\put(0.01,0.45){\includegraphics[width=0.17\unitlength]{cards/KS.pdf}}
\put(0.2,0.45){\includegraphics[width=0.15\unitlength]{cards/QS.pdf}}
\end{picture}}
\end{frame}
...
\uncover<3->{
\begin{WinningCondition}
Player has a winning strategy in the $t$-game if and only if for every set of stacks $S$ we have 
...
\3 Dealer can (i) do nothing or (ii) swap $A$ and $B$ in at most one other stack
\4 Player wins if he can pick a Royal Flush at the start of one of his turns, otherwise Dealer wins
\end{itemize}
\5 Player has a winning strategy exactly when a Hall-like condition is satisfied
\6 Vizing's edge-coloring theorem is an easy corollary
\7 most other classical edge-coloring results follow easily as well
\8 generalizes easily to multigraphs
\9 a more general game unifies much of edge-coloring theory
\end{itemize}
\end{frame}
